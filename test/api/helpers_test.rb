...
context "api/helpers" do
  ...
  test "valid songs_as_json with valid parameters" do
    ...
    assert_equal ["album", "artist", "id", "last_played", "name", "queued", "starred"], songs[0].keys.sort
    assert_equal ["album", "artist", "id", "last_played", "name", "queued", "starred"], songs[1].keys.sort
